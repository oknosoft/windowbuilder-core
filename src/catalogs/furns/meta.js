...
export const meta= {
  furns: {
    name: "пзФурнитура",
    synonym: "Фурнитура",
    illustration: "Описывает ограничения фурнитуры",
  ...
  furnSpec: {
    name: "СпецификацияФурнитуры",
    synonym: "Спецификация фурнитуры",
    illustration: "Описывает правила формирования спецификаций фурнитуры",
    inputBy: ["name", "id"],
    hierarchical: false,
    hasOwners: false,
    groupHierarchy: true,
